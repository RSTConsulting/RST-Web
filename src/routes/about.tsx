...
const steps = [
  { n: "01", t: "Initial Consultation", d: "We talk through the brief, the site, and what the builder/architect actually needs from us." },
  { n: "02", t: "Site Assessment", d: "A structural walk-through or desktop assessment - existing conditions, soil, constraints." },
  { n: "03", t: "Design & Documentation", d: "Full structural and civil design set - plans, sections, details, specifications, calculations." },
  { n: "04", t: "Council & Compliance", d: "Documentation prepared for permit submission, with revisions coordinated through the certifier." },
  { n: "05", t: "Delivery on Site", d: "Available through construction for RFIs, site queries and any structural inspection sign-offs required." },
];
        ...
        <div className="container-wide grid lg:grid-cols-12 gap-14 items-center w-full">
          <div className="lg:col-span-7">
            <Reveal>
              ...
              <h1 className="font-display font-semibold text-navy leading-[1.05] tracking-tight" style={{ fontSize: "clamp(2rem, 4.2vw, 3.75rem)" }}>
                A structural engineering consultancy built in Springvale.
              </h1>
            </Reveal>
            <Reveal delay={0.1}>
              <div className="mt-10 space-y-6 text-lg text-muted-foreground leading-relaxed max-w-2xl">
                <p>
                  RST Consulting Engineers was founded in Springvale, Victoria by <strong className="text-navy font-medium">Sineth Sareth Sar</strong> and <strong className="text-navy font-medium">Ratana Sar</strong> to serve Melbourne's residential, commercial, industrial and institutional building sectors.
                </p>
                <p>
                  Over a decade later we still work the same way we did when we started: quote honestly, deliver on time, stay involved through construction. That's the whole approach.
                </p>
              </div>
            </Reveal>
          </div>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-12 gap-14">
            <SectionHeading
              ...
              title={<>No job too big <br className="hidden md:block" />or too small.</>}
            />
            <div className="lg:col-span-7">
              <Stagger className="space-y-8">
                {[
                  { t: "Competitive quotes, without compromise.", d: "We price the actual scope of engineering required - no padding, no thinning. Cost efficiency comes from experience, not from cutting corners on the structure." },
                  { t: "Punctual, on-budget delivery.", d: "Documentation issued on the promised date. Builders, certifiers and Councils are all waiting on the engineering - we don't hold anyone up." },
                  { t: "Long-term client partnerships.", d: "A significant share of our workload comes from builders and developers who've been engaging us for more than a decade." },
                ].map((it) => (
                  <motion.div key={it.t} variants={staggerItem} className="border-l-2 border-steel pl-6">
        ...
        <div className="container-wide grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="mt-5 text-muted-foreground max-w-2xl">
              Documentation prepared to the current National Construction Code and relevant Australian Standards. Where third-party certification is required, we coordinate directly with the certifier.
            </p>
          </div>
